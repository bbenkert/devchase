<x-layout>
    <div class="bg-slate-50">
        {{-- Page Header --}}
        <section
            class="py-16 bg-gradient-to-r from-slate-900 via-blue-900 to-sky-700 text-white md:py-32 shadow-md"
        >
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="mt-4 max-w-2xl mx-auto text-lg sm:text-xl text-sky-50">
                    A showcase of web projects and code experiments I have brought to life.
                </p>
            </div>
        </section>
                        ...
                        >
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                ...
                                                stroke-width="2"
                                                d="M19.428 11.286a8 8 0 11-14.856 0M12 6v6m0 0v6m0-6h6m-6 0H6"
                                            ></path>
                                        </svg>
                                    </div>
                                @endif
                            ...
                            <div class="p-6 flex flex-col flex-grow">
                                ...
                                @else
                                    ...
                                    {{-- Placeholder to push buttons down if no description --}}
                                @endif

                                @if (! empty($project->tech_stack))
                                    <div class="mb-4">
                                        <h4
                                            class="text-xs text-slate-500 uppercase font-semibold mb-1"
                                        >
                                            Tech Stack:
                                        </h4>
                                        <div class="flex flex-wrap gap-2">
                                            @foreach ($project->tech_stack as $tech)
                                                <span
                                                    class="px-2 py-1 bg-sky-100 text-sky-700 text-xs font-medium rounded-full"
                                                >
                                                    {{ $tech }}
                                                </span>
                                            @endforeach
                                ...
                                <div
                                    class="mt-auto pt-4 border-t border-slate-200 flex items-center justify-start space-x-3"
                                >
                                    ...
                                    @if ($project->github_link)
                                        ...
                                        >
                                            <svg
                                                class="-ml-1 mr-2 h-5 w-5 text-slate-500"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                                aria-hidden="true"
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-lg text-slate-500">
                        I'm currently charting my course. Check back soon to see my completed
                        projects!
                    </p>
                    <div class="mt-6">
                        <a
