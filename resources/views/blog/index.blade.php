    ...
    <div class="bg-slate-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <form
                ...
                class="mb-12 p-6 bg-white rounded-xl shadow-lg"
            >
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach ($allCategories as $categoryName)
                                <option
                                    value="{{ $categoryName }}"
                                    @selected(request('category') === $categoryName)
                                >
                                    {{ $categoryName }}
                                </option>
                            @endforeach
                    ...
                    <div>
                        <label for="tag" class="block text-sm font-medium text-slate-700 mb-1">
                            Tag
                        </label>
                        <select
                            name="tag"
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-lg text-slate-500">
                        Your search or filter criteria didn't match any posts. Try broadening your
                        search!
                    </p>
                    <div class="mt-6">
                        <a
